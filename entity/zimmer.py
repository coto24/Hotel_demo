class zimmer():
    ...
    def __str__(self):
        return "Room {} can host {} persons, has the price of {}€/night, the color of the walls is {} and {}".format(
            self.__nummer, self.__amg, self.__preis, self.__farbe,
            'has seaview' if self.__meerblick == 1 else "doesn't have seaview")
